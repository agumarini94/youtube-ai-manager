...
def generar_pregunta_claude(tema: str = "") -> dict:
    ...
    prompt = (
        "Sos el creador de preguntas más viral de YouTube Shorts en LATAM. "
        "Tu especialidad: preguntas que dividen a la gente en dos bandos y los obligan a defender su posición en comentarios.\n\n"
        + tema_str +
        "PSICOLOGÍA VIRAL — tu pregunta debe activar UNO de estos disparadores:\n"
        "• Traición de un ser querido (hermano, pareja, mejor amigo)\n"
        "• Plata vs lealtad — ¿sacrificás la relación por dinero o viceversa?\n"
        "• Orgullo vs bien del otro — ¿humillarías a alguien para ayudarlo?\n"
        "• Supervivencia vs ética — ¿harías algo 'malo' para proteger a tu familia?\n"
        "• Secreto que destruye vs verdad que duele\n\n"
        "ANATOMÍA DE UNA PREGUNTA QUE FUNCIONA:\n"
        "✅ Específica: 'tu hermano', no 'alguien que conocés'\n"
        "✅ Dilema real: ambas opciones tienen un costo genuino\n"
        "✅ Sin respuesta obvia: si el 90% responde igual, no sirve\n"
        "✅ Divide por valores, género o generación — que genere bandos\n\n"
        "EJEMPLOS DEL NIVEL OBJETIVO (referencia de estructura y tono):\n"
        "• '¿Defenderías a tu hermano sabiendo que mintió?'\n"
        "• '¿Le contarías a tu amigo que su pareja lo engaña?'\n"
        "• '¿Dejarías ir a tu mejor amigo si te hace mal?'\n"
        "• '¿Saldrías con alguien que tiene deudas?'\n"
        "• '¿Le dirías a tu mamá que tu papá la engaña?'\n"
        "• '¿Pagarías la deuda de tu hermano sabiendo que la va a repetir?'\n\n"
        "PROHIBIDO:\n"
        "❌ Respuesta obvia para el 90% ('¿Robarías si te morís de hambre?')\n"
        "❌ Preguntas abstractas sin situación concreta ('¿qué es más importante, el amor o el dinero?')\n"
        "❌ Hipotéticos imposibles o fantásticos\n"
        ...
        "Formatos: 'La pregunta que divide a todos 🤔' / 'La mayoría se equivoca en esto 👇' / '[Tema]: ¿cuál es tu respuesta? 🤯'\n\n"
        "TÉRMINOS DE IMAGEN: 6 frases en inglés para buscar fotos REALISTAS y EMOTIVAS "
        "que ilustren la situación del dilema. Buscá situaciones humanas concretas "
        "(couple arguing, friends confrontation, family tension) — no stock genérico.\n\n"
        "HASHTAGS YouTube Shorts LATAM (nicho medio — evitar tags con >500M posts):\n"
        "Fijos: #Shorts #fyp #parati\n"
        "2 de engagement: #dilema #respondesi o #teamimonoamo o #queelegirías\n"
        "1-2 temáticos específicos al dilema — en español\n"
